...
def seed_data(db: Session):
    ...
    announcement2 = models.Announcements(id_travels=travel2.id, id_boarding_gates=gate2.id, id_users=user2.id, date_announcements="2025-03-12",status= True , observation="canceled")
    ...
    announcement6 = models.Announcements(id_travels=travel6.id, id_boarding_gates=gate6.id, id_users=user2.id, date_announcements="2025-03-16",status= True , observation="canceled")
